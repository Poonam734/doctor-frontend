...
const PatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctor-project-1.onrender.com/getuserdetails`, { headers: { 'Authorization': `${token}` } });
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://doctor-project-1.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
